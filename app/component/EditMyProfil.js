...
import { View,Text,ToastAndroid,BackHandler,Dimensions,Picker,DatePickerAndroid,ScrollView } from 'react-native';
...
class Screen extends Component {
  ...
  constructor(props){
    ...
    this.state = {
      _token: '',
      key: this.props.profil.nik,
      nik: this.props.profil.nik,
      username: this.props.profil.username,
      password: this.props.profil.password,
      nama: this.props.profil.nama,
      jenis_kelamin: this.props.profil.jenis_kelamin,
      tempat_lahir: this.props.profil.tempat_lahir,
      tanggal_lahir: this.props.profil.tanggal_lahir,
      alamat: this.props.profil.alamat,
      id_provinsi: this.props.profil.id_provinsi,
      list_provinsi: [],
      id_kota: this.props.profil.id_kota,
      list_kota: [],
      agama: this.props.profil.agama,
      pekerjaan: this.props.profil.pekerjaan,
      tlp: this.props.profil.tlp,
  ...
  componentDidMount(){
    ...
    this.getListKota(this.state.id_provinsi);
  }
